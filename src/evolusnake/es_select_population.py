...
def es_select_population(configuration: ESConfiguration, individual: ESIndividual) -> PSNode:
    ...
    match pop_kind:
        ...
        case 6:
            return ESPopulationNode6(configuration, individual)
        case 7:
            return ESPopulationNode7(configuration, individual)
        case 8:
            return ESPopulationNode8(configuration, individual)
        case 9:
            return ESPopulationNode9(configuration, individual)
        case 10:
            return ESPopulationNode10(configuration, individual)
        case 11:
            return ESPopulationNode11(configuration, individual)
        case _:
