...
test_kind_8() {
    python3 rosenbrock_main.py --population_kind 8 &
    sleep 2
    python3 rosenbrock_main.py --population_kind 8 --randomize_population --num_of_iterations 5000 &
    sleep 2
    python3 rosenbrock_main.py --population_kind 8 --randomize_population --num_of_iterations 10000 &
    sleep 2
    python3 rosenbrock_main.py --population_kind 8 --randomize_population --num_of_iterations 15000 &
    sleep 2
}
