...
run_kind() {
    ...
    sleep 2
    python3 $main_file -k $1 -m $num_of_mutations -i $iterations4 $randomize --user_options net=1 &
    sleep 2
    python3 $main_file -k $1 -m $num_of_mutations -i $iterations4 $randomize --user_options net=2 &
    sleep 2
}
